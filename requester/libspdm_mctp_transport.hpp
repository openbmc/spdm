...
class SpdmMctpTransport : public SpdmTransport
{
  public:
     ...
     */
    explicit SpdmMctpTransport(uint8_t eid) : eid(eid) {}
    ...
    uint8_t eid;        ///< MCTP Endpoint ID for this device
    MctpIoClass mctpIo; ///< MCTP socket I/O handler
    MctpMessageTransport mctpMessageTransport; ///< MCTP message encode/decode
                                               ///< layer
