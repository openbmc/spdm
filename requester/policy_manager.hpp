        ...
        Policy<PolicyManager>
{
  public:
    ...
    auto set_property(allowed_versions_t, auto allowed_versions) -> bool
    {
        return update_property(allowed_versions_, allowed_versions,
                               allowed_versions_callback_);
    }

    auto set_property(allowed_algorithms_aead_t,
                      auto allowed_algorithms_aead) -> bool
    {
        return update_property(allowed_algorithms_aead_,
                               allowed_algorithms_aead,
                               allowed_algorithms_aead_callback_);
    }
                      ...
                      auto allowed_algorithms_base_hash) -> bool
    {
        return update_property(allowed_algorithms_base_hash_,
                               ...
                               allowed_algorithms_base_hash_callback_);
    }
                      ...
                      auto allowed_algorithms_base_asym) -> bool
    {
        return update_property(allowed_algorithms_base_asym_,
                               ...
                               allowed_algorithms_base_asym_callback_);
    }
    ...
    template <typename F>
        requires std::invocable<F, bool>
    auto on_allow_extended_algorithms(F&& callback) -> void
    {
        allow_extended_algorithms_callback_ = std::forward<F>(callback);
    }

    template <typename F>
        requires std::invocable<F, const decltype(allowed_versions_)&>
    auto on_allowed_versions(F&& callback) -> void
    {
        allowed_versions_callback_ = std::forward<F>(callback);
    }

    template <typename F>
        requires std::invocable<F, const decltype(allowed_algorithms_aead_)&>
    auto on_allowed_algorithms_aead(F&& callback) -> void
    {
        allowed_algorithms_aead_callback_ = std::forward<F>(callback);
    }

    template <typename F>
        requires std::invocable<F, const decltype(allowed_algorithms_base_hash_)&>
    auto on_allowed_algorithms_base_hash(F&& callback) -> void
    {
        allowed_algorithms_base_hash_callback_ = std::forward<F>(callback);
    }

    template <typename F>
        requires std::invocable<F, const decltype(allowed_algorithms_base_asym_)&>
    auto on_allowed_algorithms_base_asym(F&& callback) -> void
    {
        allowed_algorithms_base_asym_callback_ = std::forward<F>(callback);
    }
  ...
  private:
    ...
    std::function<void(const decltype(allowed_versions_)&)>
        allowed_versions_callback_{nullptr};
    std::function<void(const decltype(allowed_algorithms_aead_)&)>
        allowed_algorithms_aead_callback_{nullptr};
    std::function<void(const decltype(allowed_algorithms_base_hash_)&)>
        allowed_algorithms_base_hash_callback_{nullptr};
    std::function<void(const decltype(allowed_algorithms_base_asym_)&)>
        allowed_algorithms_base_asym_callback_{nullptr};
};
