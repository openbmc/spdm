...
/**
 * @brief D-Bus Certificate interface implementation for SPDM devices.
 * @details Exposes a single certificate slot retrieved from an SPDM responder
 *          via the xyz.openbmc_project.Certs.Certificate D-Bus interface.
 */
class Certificate :
